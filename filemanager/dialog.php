	...
	<div class="navbar-inner">
		...
		<div class="filters">
			...
			<div class="span4 half" style="text-align: center;">
				<?php if($upload_files){ ?>
				<button class="tip btn upload-btn btn-success" title="<?php echo  trans('Upload_file');?>"><i class="rficon-upload"></i> Unggah File Baru</button>
				<?php } ?>
				...
				if(in_array($file_array['extension'], $ext_img)){
					...
					if($ftp){
						...
						if(!file_exists($src_thumb) ){
							if(!create_img($file_path, $creation_thumb_path, 200, 150,'crop',$config)){
								$src_thumb=$mini_src="";
							}
						}
						//check if is smaller than thumb
						list($img_width, $img_height, $img_type, $attr)=@getimagesize($file_path);
						if($img_width<200 && $img_height<150){
							$src_thumb=$file_path;
							$show_original=true;
						}
